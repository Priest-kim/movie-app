import { get_current_component, current_component, set_current_component } from 'svelte/internal';
    ...
    if (!handledMethods.includes(prop) && !forwardedMethods.includes(prop)) {
      Object.defineProperty(proxy, prop, {
        ...
        set(value) {
          ...
          cmp[prop] = value; // who knows? maybe the value has been transformed somehow
  ...
  if (canAccept) {
    hot.accept(async arg => {
      ...
      if (!ignoreCss) {
        ...
        if (cssChanged) removeStylesheet(previousCssId); // guard: css only change
...
const applyHmr$1 = makeApplyHmr(args => Object.assign({}, args, {
  hot: args.m.hot
}));
