<script>
  ...
  import { seachMovieWithId, theMovie, loading } from "~/store/movie";
  ...
  const requestDifferentSizeImage = (url, size = 700) => {
  ...
  {:else}
    <div class="movie-details">
      ...
      <div class="specs">
        ...
        <div class="labels">
          <span>{$theMovie.Released}</span><span class="dot">•</span>
          <span>{$theMovie.Runtime}</span><span class="dot">•</span>
